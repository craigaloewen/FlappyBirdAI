...
//File provided by AI-Junkie.com
//and modified by Craig Loewen on February 02 2016



///////////////////////GLOBALS ////////////////////////////////////

char*			szApplicationName = "Flappy Bird AI";
char*			szWindowClassName = "FlappyAI";


//The controller class for this simulation
//Add in Controller
flappyController* g_pController;

//create an instance of the parameter class.
CParams   g_Params;

//Probably shouldn't be doing this but it's okay for now
CTimer* globalTimer_p;
	...
	LPARAM lparam)
{
	...
	case WM_CREATE:
	{
		...
		g_pController = new flappyController(hwnd);
	...
	case WM_KEYUP:
	{
		...
		case 'G':
		{
			g_pController->showAIBrainToggle();
		}
		break;
		
		case 'H':
		{
			//Not good practice here!!
			if (globalTimer_p) {
				if (globalTimer_p->getFps() == 120) {
					globalTimer_p->setFps(5);
				}
				else {
					globalTimer_p->setFps(120);
				}
			}
		}
		break;
